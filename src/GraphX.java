...
public class GraphX {
    ...
    private Bag<Integer>[] harmonyEdges;
    ...
    public GraphX(int V) {
        ...
        harmonyEdges = (Bag<Integer>[]) new Bag[V];
        for (int v = 0; v < V; v++) {
            harmonyEdges[v] = new Bag<Integer>();
        }
    }
    ...
    public boolean isHarmonyEdge(int toSearch, int toFind) {
        for (Integer integer : harmonyEdges[toSearch]) {
            if (toFind == integer) {
                return true;
            }
        }
    ...
    public void addEdge(int v, int w, int c) {
        ...
        adj[w].add(v);
        if (c == 0) {
            harmonyEdges[v].add(w);
            harmonyEdges[w].add(v);
        }
    }
